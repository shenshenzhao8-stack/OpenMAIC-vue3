...
<template>
  <div ref="containerRef" class="spotlight-overlay">
    <svg v-if="activeId && rect" class="spotlight-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
      <defs>
      ...
      />
      <!-- 目标边缘白色边框 -->
      <rect :x="rect.x" :y="rect.y" :width="rect.w" :height="rect.h" fill="none" stroke="#ffffff" stroke-width="0.6" />
    </svg>
  </div>
</template>
