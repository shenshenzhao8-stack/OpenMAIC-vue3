...
import type { ImageElementFilters, PPTElementShadow, SlideBackground } from '#/types/dsl';
 ...
 */
export function resolveSlideBackgroundStyle(background: SlideBackground | undefined): CSSProperties {
